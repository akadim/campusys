 ...
 */
class Campus extends \campusys\PedagogieBundle\Entity\Campus implements \Doctrine\ORM\Proxy\Proxy
{
    ...
    {
        $this->__load();
        return parent::setDeanName($deanName);
    }

    public function getDeanName()
    {
        $this->__load();
        return parent::getDeanName();
    }
    ...
    {
        return array('__isInitialized__', 'id', 'name', 'address', 'slogan', 'logo', 'description', 'created', 'deanName', 'active', 'university', 'filieres');
    }
